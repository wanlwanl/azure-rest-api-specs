...
``` yaml
openapi-type: arm
tag: package-preview-2000-11
```


### Tag: package-preview-2000-11

These settings apply only when `--tag=package-preview-2000-11` is specified on the command line.

```yaml $(tag) == 'package-preview-2000-11'
input-file:
  - Microsoft.Addons/preview/2000-11-01/addons-swagger.json
```
### Tag: package-2018-03
