...
``` yaml
openapi-type: arm
tag: package-preview-2012-01
```


### Tag: package-preview-2012-01

These settings apply only when `--tag=package-preview-2012-01` is specified on the command line.

```yaml $(tag) == 'package-preview-2012-01'
input-file:
  - Microsoft.Addons/preview/2012-01-19/addons-swagger.json
```
### Tag: package-2018-03
