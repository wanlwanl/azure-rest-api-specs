...
``` yaml
openapi-type: arm
tag: package-preview-2001-01
```


### Tag: package-preview-2001-01

These settings apply only when `--tag=package-preview-2001-01` is specified on the command line.

```yaml $(tag) == 'package-preview-2001-01'
input-file:
  - Microsoft.Addons/preview/2001-01-16/addons-swagger.json
```
### Tag: package-2018-03
